    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="商品编码" prop="shangpinbianma">
            <el-input v-model="ruleForm.shangpinbianma" 
                placeholder="商品编码" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shangpinbianma" label="商品编码" prop="shangpinbianma">
              <el-input v-model="ruleForm.shangpinbianma" 
                placeholder="商品编码" readonly></el-input>
          </el-form-item>
        </div>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../ssmcakkg/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
